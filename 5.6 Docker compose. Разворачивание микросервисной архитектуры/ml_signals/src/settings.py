...
class Settings(BaseSettings):
    APP_NAME: str = "Trading ML Service"
    APP_VERSION: str = "1.0.0"

    ML_SIGNALS_HOST: str = pydantic.Field("0.0.0.0")
    ML_SIGNALS_PORT: int = pydantic.Field("7777")

    API_TRADER_HOST: str = pydantic.Field("0.0.0.0")
    API_TRADER_PORT: int = pydantic.Field("1236")

    TICKER: str = pydantic.Field("SBER")
    TRADE_AMOUNT: int = pydantic.Field(1)

    ML_MODEL_PATH: str = pydantic.Field("/home/python/app/models/chronos-t5-tiny/")
    ML_MODEL_NAME: str = "chronos-t5-tiny"
    ML_MODEL_VERSION: str = "1.0.0"
    DEVICE: str = pydantic.Field("cpu")
